...
const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  Objectives: {
    ...
    columns: [
      ...
      { key: 'typeAr',      labelAr: 'نوع الهدف',          labelEn: 'Type',            type: 'badge', statusColors: { استراتيجي: '#147a6d', تشغيلي: '#0277BD', Strategic: '#147a6d', Operational: '#0277BD' } },
      { key: 'ownerAr',     labelAr: 'المالك',             labelEn: 'Owner',           type: 'people' },
      { key: 'unitAr',      labelAr: 'الوحدة',             labelEn: 'Unit',            type: 'badge', statusColors: { 'لا يوجد': '#f29221', 'N/A': '#f29221' } },
      { key: 'departmentAr',labelAr: 'الإدارة العامة',     labelEn: 'Department',      type: 'badge', statusColors: { 'لا يوجد': '#f29221', 'N/A': '#f29221' } },
      { key: 'relatedStrategyAr', labelAr: 'الاستراتيجية للربيط', labelEn: 'Linked Strategy', type: 'badge', statusColors: { 'لا يوجد': '#f29221', 'N/A': '#f29221' } },
      { key: 'levelAr',     labelAr: 'مستوى الهدف',        labelEn: 'Level',           type: 'badge', statusColors: { 'رئيسي': '#f29221', 'فرعي مستوى ثاني': '#f29221', Main: '#f29221', 'Sub Level 2': '#f29221' } },
    ],
  },
  ...
  KPIs: {
    ...
    columns: [
      ...
      { key: 'typeAr',           labelAr: 'نوع المؤشر',     labelEn: 'Type',         type: 'badge',  statusColors: { استراتيجي: '#147a6d', تشغيلي: '#0277BD' } },
  ...
  Programs: {
    ...
    columns: [
      ...
      { key: 'budget',      labelAr: 'الميزانية',   labelEn: 'Budget',   type: 'currency' },
      { key: 'completion',  labelAr: 'الإنجاز',     labelEn: 'Completion',type: 'progress' },
      { key: 'status',      labelAr: 'الحالة',      labelEn: 'Status',   type: 'badge',    statusColors: { execution: '#2E7D52', planning: '#006064', completed: '#147a6d', cancelled: '#B71C1C' } },
    ],
  },
  ...
  Stakeholders: {
    ...
    columns: [
      ...
      { key: 'type',          labelAr: 'النوع',         labelEn: 'Type',      type: 'badge', statusColors: { government: '#0277BD', internal: '#147a6d', external: '#6A1B9A', private: '#37474F' } },
  ...
  LessonsLearned: {
    ...
    columns: [
      ...
      { key: 'category',  labelAr: 'الفئة',     labelEn: 'Category',      type: 'badge', statusColors: { risk: '#B71C1C', process: '#0277BD', technical: '#147a6d', management: '#6A1B9A' } },
