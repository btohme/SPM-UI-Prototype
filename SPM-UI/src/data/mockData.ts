...
export const MOCK_USERS = [
  ...
  { id: 'u9', nameAr: 'سامي موسى', nameEn: 'Sami Moussa', email: 'sami@hrsd.sa', role: 'فريق الاستراتيجية', avatar: '' },
